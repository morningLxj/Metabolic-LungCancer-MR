...
| **Dataset** | **Endpoint** | **N** | **HR (high vs low risk group, 95% CI; Cox model)** | **P-value** | **C-index** | **AUC (3-year)** | **Calibration slope (3Y)** | **Calibration R² (3Y)** | **Cutoff method** |
|:--|:--:|--:|:--|:--:|:--:|:--:|:--:|:--:|:--|
| TCGA (training) | OS | 364 | 2.88 (2.05–4.05) | 2.32 × 10⁻¹⁰ | 0.664 | 0.685 | 1.227 | 0.843 | Median (training cohort) |
| GSE39279 (external) | RFS | 122 | 2.10 (1.10–4.03) | 0.022 | NA | NA | NA | NA | Maxstat-derived optimal cutoff |
| GSE30219 (external) | OS | 274 | 1.57 (1.17–2.10) | 0.002 | NA | NA | NA | NA | Maxstat-derived optimal cutoff |

*Figure/Table consistency note: all metrics in this table are aligned with the final M12 model outputs used in Figure 5–7 and Supplementary Figure S6.*
