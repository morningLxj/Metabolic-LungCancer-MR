...
author_1 = "Xiongjie Li (XL): Conceived the study, designed the methodological framework, performed data collection, conducted Mendelian randomization analyses and prognostic modeling, and drafted the original manuscript."
author_2 = "Fengyue Zhang (FZ): Participated in data collection, Mendelian randomization analyses, and prognostic modeling."
...
funding_1 = "The authors declare that no specific funding, grants, or other financial support were received for the preparation of this manuscript."
competing_1 = "The authors declare no competing interests."
ethics_1 = "Ethical review and approval were waived for this study because all analyses were based on publicly available, de-identified summary statistics and public molecular datasets, including GWAS summary data, TCGA data, and CPTAC data. All original studies cited in this work obtained the relevant ethical approvals and informed consent."
